...
| Codex UI | Partially implemented — data model done (#36) | Now an entity-profile + manuscript-backlink index, not a CRUD panel. #36 done: CodexEntry has aliases/matchCase, frontmatter parse/serialize in codex.rs, ReadCodexResult for read, save accepts aliases+matchCase. Remaining: #37 (scan cmds), #38 (jump), #4 (index panel + center-pane profile), #39 (search panel), #40 (define-from-selection); deferred #41/#42/#43. See "Codex as a manuscript index" decision. |
